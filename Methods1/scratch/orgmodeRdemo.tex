...
\begin{figure}[p]
\centering
\includegraphics[width=0.8\textwidth, width=0.8\textwidth,placement=[p]]{/home/nooreen/Documents/R/foo-fig2.pdf}
\caption{Scatter Plot with Regression Line Scatter Plot with Cubic Regression Curve}
\end{figure}
